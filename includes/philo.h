...
/*   Updated: 2024/11/12 03:14:36 by mzelouan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
// INIT DATA
int						__init(t_philo **philos, t_fork **forks, t_args *args,
							t_monitor **monitor);
...
// CLEAN/
void					cleanup(t_philo *philos, t_monitor *monitor,
							t_args *args, t_fork *forks);
#endif
